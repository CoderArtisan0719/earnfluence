	...
	return (
		<div className='min-h-full absolute top-0 left-0 w-full'>
			<div className='relative w-full h-[100vh]'>
				...
				<Link href={"/shoenice"} className='absolute top-[25px] text-3xl right-[20px] cursor-pointer z-[200]'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="transparent" stroke="#F2F1F3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-testid="icon-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></Link>
