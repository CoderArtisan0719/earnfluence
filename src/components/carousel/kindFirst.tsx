...
const KindFirst = ({ title, stars }: ExploreStarsProps) => {
    ...
    return (
        <div className="w-[200px] rounded-[20px] relative overflow-hidden">
            ...
            <div className="mt-[10px] p-[5px]">
                <p className="text-blue-300 text-[14px]">Only 5 left!</p>
                <p className="font-bold text-[16px]">
                    {card.title}
                </p>
                <p className="text-gray-400">Virual Star</p>
                ...
                <div className="flex items-center justify-start gap-1">
                    <div className="flex justify-center items-center">
                        <MdOutlineStar className="fill-yellow-300" />
                        <p className="">
                            4.42
                            <span className="text-[#BFBAC4]">(43)</span>
                        </p>
                    </div>

                    <div className="flex justify-center items-center">
                        <PiLightningFill className="fill-yellow-300" />
                        <p className="">
                            24hr
                        </p>
                    </div>
